// components/menus/EditPostDialog.tsx
"use client"
...
export function EditPostDialog({ postId, initialContent, onClose, onUpdate }: EditPostDialogProps) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex gap-3 p-6 border-t border-gray-200">
          <button
            ...
            className="flex-1 py-3 px-4 bg-white border-2 border-gray-300 rounded-lg font-bold text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
